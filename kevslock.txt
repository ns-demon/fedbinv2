...
game.StarterGui:SetCore("SendNotification", {
    Title = "Niggas ware's ware";
    Text = "Welcome fags add qrcode1 on discord";
    Icon = "RBXID OR BLANK";
    Duration = "DURATION IN SECONDS";
...
Tab3:Button("Realistic (wallet only) Speed Glitch (V)",function(bool)
...
Tab3:Button("FLY Gui (works idk)",function(bool)
    loadstring(game:HttpGet("https://pastebin.com/i0Ss0N8z"))()
end)
